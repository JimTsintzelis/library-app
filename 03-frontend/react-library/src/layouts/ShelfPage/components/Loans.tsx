    ...
    useEffect(() => {
        const fetchUserCurrentLoans = async () => {
            if (authState && authState.isAuthenticated) {
                const url = `${process.env.REACT_APP_API}/books/secure/curretloans`;
                ...
                <>
                    ...
                    {shelfCurrentLoans.map(shelfCurrentLoan => (
                        <div key={shelfCurrentLoan.book.id}>
                            ...
                            <hr/>
                            <LoansModal shelfCurrentLoan={shelfCurrentLoan} returnBook={returnBook} renewLoan={renewLoan} mobile={false}/>
                ...
                <>
                    ...
                    {shelfCurrentLoans.map(shelfCurrentLoan => (
                        <div key={shelfCurrentLoan.book.id}>
                            ...
                            <hr/>
                            <LoansModal shelfCurrentLoan={shelfCurrentLoan} returnBook={returnBook} renewLoan={renewLoan} mobile={true} />
