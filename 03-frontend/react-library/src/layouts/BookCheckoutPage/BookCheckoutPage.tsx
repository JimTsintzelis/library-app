...
export const BookCheckoutPage =() => {
    ...
    const [isLoadingBookCheckedOut, setIsLoadingBooksCheckedOut] = useState(true);
    ...
    useEffect(() => {
        const fetchUserCheckedOutBook = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const bookIsCheckedOutResponseJson = await bookCheckedOut.json();
                setIsCheckedOut(bookIsCheckedOutResponseJson);

            }
            setIsLoadingBooksCheckedOut(false);
    ...
    return (
        <div>
            <div className='container d-none d-lg-block'>
                ...
                Please pay outstanding feed and/or return late book(s).
                </div>
